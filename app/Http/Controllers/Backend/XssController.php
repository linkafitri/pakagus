...
class XssController extends Controller
{
     ...
     public function XssView(){
        ...
        return view('backend.xss.view_xss', $data);
    }
    public function XssAdd(){
        //$allDataMhs=User::all();
        //$data['allDataMhs']=Mahasiswa::all();
        return view('backend.xss.add_xss');
    }
    public function XssStore(Request $request){
        ...
        return redirect()->route('xss.view')->with('info','Tambah Mahasiswa berhasil');
    }

    public function XssEdit($id){
        //dd('berhasil masuk controller user edit');
        $editData= Mahasiswa::find($id);
        return view('backend.xss.edit_xss', compact('editData'));
    ...
    public function XssUpdate(Request $request, $id){
        ...
        return redirect()->route('xss.view')->with('info','Update Mahasiswa berhasil');
    }
    ...
    public function XssDelete($id){
        ...
        return redirect()->route('xss.view')->with('info','Delete Mahasiswa berhasil');
