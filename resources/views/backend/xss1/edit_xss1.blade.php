		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Edit Xss</h4>
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form method="post" action="{{route('xss1.update', $editData->id)}}">
                    @csrf 
                        <div class="row">
                            <div class="col-md-6">
                            <div class="form-group">
								...
								<div class="controls">
									<input type="number" name="nim" value="{{$editData->nim}}" class="form-control" required data-validation-required-message="This field is required"> </div>
							</div>
                            </div>
