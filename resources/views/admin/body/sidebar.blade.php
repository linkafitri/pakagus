    ...
    <section class="sidebar">	
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('mhs.view')}}"><i class="ti-more"></i>Tampilkan Mahasiswa</a></li>
            <li><a href="{{route('mhs.add')}}"><i class="ti-more"></i>Tambah Mahasiswa</a></li>
          </ul>
        </li> 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('lagu.view')}}"><i class="ti-more"></i>Tampilkan Lagu</a></li>
            <li><a href="{{route('lagu.add')}}"><i class="ti-more"></i>Tambah Lagu</a></li>
          </ul>
        </li> 
